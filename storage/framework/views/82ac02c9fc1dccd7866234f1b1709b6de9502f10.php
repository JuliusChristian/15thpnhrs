		...
		<?php echo Form::open(array('name' => 'search_form', 'url' => URL::to('attendees'), 'class'=>'form-inline', 'role' => 'form')); ?>
			...
			<div class="form-group">
				...
				<div class="input-group input-group-sm">
					...
					<input type="date" class="form-control" name="qt" value="<?php echo e($day); ?>">
				</div>
			...
			</div><label class="pull-right badge badge-primary"><?php echo e(\Carbon\Carbon::createfromformat('Y-m-d', $day)->format('F j, Y')); ?></label>
		<?php echo Form::close(); ?>
		...
		<table class="table table-bordered table-condensed table-striped table-hover">
			...
			<tbody>
			    ...
			    <tr>
					...
					<td><?php echo e($row->visitor->vis_designation); ?></td>
					...
					<td><?php echo e(\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $row->created_at)->format('F j, Y G:i:A')); ?> | <text class="label label-danger"><?php echo e(\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $row->created_at)->diffForHumans()); ?></text></td>
				</tr>
			    <?php endforeach; ?>
			</tbody>
		</table>
